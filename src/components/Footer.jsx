        ...
        <div className="container text-secondary">
          ...
          <div className='grid gap-10 sm:grid-cols-2 lg:grid-cols-4'>
            ...
            <div>
              ...
              <div className='pb-[72px]'>
                <ul className='flex flex-wrap gap-4 text-base'>
                  <li className='w-10 h-10 flex justify-center items-center text-secondary border rounded-[50%]'>
                    <a href="#"><FaTwitter /></a>
                  </li>
                  <li className='w-10 h-10 flex justify-center items-center text-secondary border rounded-[50%]'>
            ...
            <div className='pb-2.5'>
              ...
              <div className='w-full border flex items-center rounded overflow-hidden'>
                <input
                  className='w-full py-2.5 px-5 text-sm'
                  type="email"
